...
public class InterfaceGraphique extends JFrame {
    ...
    private class optionJpanelDroite extends JPanel implements ActionListener {
        ...
        private JComboBox<Doctor> choixDocteurBox = new JComboBox<Doctor>();
        ...
        public void MAJdesBarres() {
            ...
            for (Doctor var : resteDuProjet.getDoc()) {
        ...
        public void chargementInfoEnfonctionDateDocteur() {
            docteurChoisit = (Doctor) choixDocteurBox.getSelectedItem();
