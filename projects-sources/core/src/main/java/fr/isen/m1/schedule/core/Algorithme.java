...
/**
 * emploiDuTemps cette algorithme prend les rendez vous dont il a besoin pour s'executer en fonction
 * de la journee ou il est et il doit renvoyer toute la list des rendez vous qu'il a demander. cette
 * list sera ensuite renvoyer et accestockage pourras ensuite comparer cette liste et faire les
 * ajustement lui meme dans la bdd
 */
